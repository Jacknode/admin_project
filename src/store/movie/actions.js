...
export default {
  ...
  AddMovieType(store,data){
    return new Promise((relove, reject) => {
      axios.post('http://webservice.1000da.com.cn/Type/Insert',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  UpdateMovieType(store,data){
    return new Promise((relove, reject) => {
      axios.post('http://webservice.1000da.com.cn/Type/Update',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
...
AuditSubmitOk(store,data){
  return new Promise((relove, reject) => {
    axios.post('http://webservice.1000da.com.cn/Validate/ValiateVedio',JSON.stringify(data),{
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded'
      }
    }).then(data=>{
