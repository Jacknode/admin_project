...
export default {
  ...
  initCarBrands({commit},obj){
    return new Promise((relove, reject) => {
      axios.post('http://webservice.1000da.com.cn/CRAttribute/Select',JSON.stringify(obj),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  AddCarRent(store,data){
    return new Promise((relove, reject) => {
      axios.post('http://webservice.1000da.com.cn/CRCar/Insert',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  UpdateCarRent(store,data){
    return new Promise((relove, reject) => {
      axios.post('http://webservice.1000da.com.cn/CRCar/Update',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  DeleteCarRent(store,data){
    return new Promise((relove, reject) => {
      axios.post('http://webservice.1000da.com.cn/CRCar/Delete',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  AddCarProperties(store,data){
    return new Promise((relove, reject) => {
      axios.post('http://webservice.1000da.com.cn/CRAttribute/Insert',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  UpdateCarProperties(store,data){
    return new Promise((relove, reject) => {
      axios.post('http://webservice.1000da.com.cn/CRAttribute/Update',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  DeleteCarProperties(store,data){
    return new Promise((relove, reject) => {
      axios.post('http://webservice.1000da.com.cn/CRAttribute/Delete',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  initCarCityLandmarksBasisType({commit},data){
    return new Promise((relove, reject) => {
      axios.post('http://webservice.1000da.com.cn/CRAttribute/Select',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  initCarCityLandmarks({commit},data){
    return new Promise((relove, reject) => {
      axios.post('http://webservice.1000da.com.cn/CityLandmark/Select',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  AddCarCityLandmarks(store,data){
    return new Promise(function (relove, reject) {
      axios.post('http://webservice.1000da.com.cn/CityLandmark/Insert', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  UpdateCarCityLandmarks(store,data){
    return new Promise(function (relove, reject) {
      axios.post('http://webservice.1000da.com.cn/CityLandmark/Update', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  DeleteCarCityLandmarks(store,data){
    return new Promise(function (relove, reject) {
      axios.post('http://webservice.1000da.com.cn/CityLandmark/Delete', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
